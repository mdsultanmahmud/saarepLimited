...
const Modal = ({ names }) => {
    ...
    return (
        <div>
            <input type="checkbox" id="see-bio-modal" className="modal-toggle" />
            <div className="modal">
                <div className="modal-box relative" id='custom-modal'>
                    <label htmlFor="see-bio-modal" className="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
